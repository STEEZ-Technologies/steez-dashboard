...
// Ported from ~/Projects/steez/components/ui/hero-geometric.tsx — same noise
// gradient shader used on the STEEZ marketing site's hero, recolored to the
// dashboard's forest/mint brand.
